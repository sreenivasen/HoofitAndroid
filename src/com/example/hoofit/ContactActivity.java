...
public class ContactActivity extends Activity {
	...
	final ContactActivity contact = this;
	...
	public class DrawerItemClickListener implements
		...
		public void onItemClick(AdapterView parent, View view, int position,
			...
			switch (position) {
			case 0:
				Intent intent1 = new Intent(contact, HomeActivity.class);
				startActivity(intent1);
				drawerLayout.closeDrawer(drawerListView);
				break;
			case 1:
				Intent intent2 = new Intent(contact, ProfileActivity.class);
				startActivity(intent2);
				drawerLayout.closeDrawer(drawerListView);
				break;
			case 2:
				Intent intent3 = new Intent(contact, SettingsActivity.class);
				startActivity(intent3);
				drawerLayout.closeDrawer(drawerListView);
				break;
			case 3:
				Intent intent4 = new Intent(contact, AboutActivity.class);
